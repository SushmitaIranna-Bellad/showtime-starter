...
import { Movie, Theater, TheaterWithShowtimes, Showtime } from "@/types/movie";
import TicketCountSelector from "./TicketCountSelector";
...
const TheaterShowtimesModal = ({ movie, isOpen, onClose }: TheaterShowtimesModalProps) => {
  ...
  const handleShowtimeClick = (showtime: Showtime, theater: TheaterWithShowtimes) => {
    if (showtime.available_seats < ticketCount) {
      toast.error(`Only ${showtime.available_seats} seats available for this show`);
      return;
    }
  ...
  const handleSeatConfirm = (selectedSeats: string[]) => {
    toast.success(`Selected seats: ${selectedSeats.join(", ")}`);
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative w-full max-w-4xl max-h-[90vh] mx-4 bg-card rounded-2xl overflow-hidden shadow-2xl animate-fade-in">
          ...
          <div className="sticky top-0 bg-card/95 backdrop-blur-sm border-b border-border z-10">
            ...
            {/* Date Selection and Ticket Count */}
          ...
          {/* Content */}
          <div className="overflow-y-auto max-h-[calc(90vh-220px)] p-4 md:p-6">
            {loading ? (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                      {theater.showtimes.map((showtime) => {
                        const hasEnoughSeats = showtime.available_seats >= ticketCount;
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className={`flex items-center justify-center gap-1 text-xs mt-1 ${
                              hasEnoughSeats ? 'text-green-500' : 'text-destructive'
                            }`}>
